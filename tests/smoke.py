...
def main():
    ...
    assert_contains("src/game.js", "function appendRunHistory")
    assert_contains("src/styles.css", ".run-history-item")
    ...
    assert_contains("src/storage.js", "function normalizeRun")
